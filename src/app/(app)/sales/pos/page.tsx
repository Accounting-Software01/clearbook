...
interface Item {
  ...
  stock: number;
  base_price: number;
  cost_price: number;            // added for expense accounting
...
interface CartItem extends Item {
  ...
  discount: number;
  vat: number;
  is_freebie?: boolean;          // flag for free lines
}
...
// ... (RecentTransactions and RecentInvoices remain unchanged) ...
...
export default function PointOfSalePage() {
  ...
  // Recalculate VAT when rate changes
  useEffect(() => {
  ...
  const fetchInitialData = useCallback(async () => {
    ...
    try {
      ...
      // Ensure cost_price exists and default to 0
