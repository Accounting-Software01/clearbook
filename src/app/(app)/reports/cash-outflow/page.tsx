                        ...
                        <CardContent>
                            <Table>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow className="font-semibold bg-gray-50"><TableCell>Net Cash Outflow from Operating Activities</TableCell><TableCell className="text-right">{formatCurrency(data.totalOperating)}</TableCell></TableRow>
                                    ...
                                    <TableRow className="font-semibold bg-gray-50"><TableCell>Net Cash Outflow from Investing Activities</TableCell><TableCell className="text-right">{formatCurrency(data.totalInvesting)}</TableCell></TableRow>
                                    ...
                                    <TableRow className="font-semibold bg-gray-50"><TableCell>Net Cash Outflow from Financing Activities</TableCell><TableCell className="text-right">{formatCurrency(data.totalFinancing)}</TableCell></TableRow>
                                </TableBody>
                                <TableFooter>
