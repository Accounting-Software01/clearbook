...
export default function DashboardPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center gap-6 p-8 ">
      {/* Left Column */}
      <Card className="w-full md:w-1/3 h-[90vh] flex flex-col overflow-y-auto bg-transparent p-0">
      ...
      <div className="w-px bg-gray-300 h-[90vh]"></div>

      {/* Right Column */}
      <Card className="w-2/3 h-[90vh] flex flex-col bg-white">
         <CardHeader>
