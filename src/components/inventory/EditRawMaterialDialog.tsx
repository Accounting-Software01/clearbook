...
export const EditRawMaterialDialog: React.FC<EditRawMaterialDialogProps> = ({ open, onOpenChange, item, onSuccess }) => {
    const { user } = useAuth();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('https://hariindustries.net/api/clearbook/update-raw-material.php', {
                method: 'POST',
            ...
            toast.update(id, { title: 'Success!', description: 'Raw material has been updated.' });
            onSuccess();
            onOpenChange(false);
