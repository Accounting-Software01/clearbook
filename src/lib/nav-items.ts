...
export const allNavItems = [
...

    {
        ...
        label: 'Fixed Assets',
        icon: Database,
        permission: 'view_reports_transactions',
    },
                ...
                subItems: [
                    {
                        ...
                        icon: Archive,
                        permission: 'view_reports_accounting',
                    },
                    {
                    ...
                    {
                        href: '/reports/income-tax',
                        label: 'Income Tax (NG 2026)',
                        icon: Landmark,
                        permission: 'view_reports_accounting',
                    },
                    {
...

    {
        ...
        subItems: [
            ...
            },
            {
                ...
                icon: FileClock,
                permission: 'view_purchase_invoices',
            },
        ],
    },
