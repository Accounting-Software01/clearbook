...
/************************************
 * FETCH TAX AUTHORITIES
 ************************************/
try {
    $sql = "SELECT id, name, short_name, authority_type, jurisdiction, default_tax_rate, tax_id FROM tax_authorities WHERE status = 'active' AND company_id = ?";
